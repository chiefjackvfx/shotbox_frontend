...
WINDOW_TITLE = "Patcha 3D Cones v1.2.9"
...
def create_box_cone():
   ...
   edges = [[i0, i1], [i0, i2], [i0, i3], [i0, i4], [i1, i2], [i1, i3], [i2, i4], [i3, i4]]
   for edge in edges:
       tde4.add3DModelLine(pg, model, edge)
   faces = [
       [i0, i1, i3],
       [i0, i3, i4],
       [i0, i4, i2],
       ...
       [i1, i2, i4, i3]]
   for face in faces:
       tde4.add3DModelFace(pg, model, face)
